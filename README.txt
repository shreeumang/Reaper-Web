...
3.Just provide the path of spring.bat file which is located inside Api application folder and also provide the path for run-Angluar.bat file.simillar to this (C:\Users\Dell\eclipse-workspace\ApiApplication\runSpring.bat) (C:\Users\Dell\eclipse-workspace\ApiApplication\run-Angular.bat)
